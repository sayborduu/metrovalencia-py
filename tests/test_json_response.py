...
class TestJsonResponsePrevisiones(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
    ...
    def test_get_returns_dict(self, mock):
        ...
        mock_response.json.return_value = {"previsiones": []}
...
class TestJsonResponseParadas(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
    ...
    @patch("metrovalencia.http.httpx.Client")
    def test_buscar_returns_list(self, mock):
        result = self.metro.paradas.buscar("Alameda")
        self.assertIsInstance(result, list)


class TestJsonResponseIncidencias(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
...
class TestJsonResponseTarjetas(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
...
class TestJsonResponseRutas(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
...
class TestJsonResponseTarifas(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
...
class TestJsonResponseComunicaciones(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
...
class TestJsonResponseV2(unittest.TestCase):
    def setUp(self):
        self.metro = MetroValencia(app_name="test", contact="test@test.com", response_type="json")
